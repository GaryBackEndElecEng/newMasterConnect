  ...
  return (
    <ThemeProvider theme={theme}>
      <Router>
        <Routes>
          <Route
            path="/master_connectCa_sitemap.xml"
            element={<MasterConnectCa />}
          />
          <Route
            path="/master_connectCom_sitemap.xml"
            element={<MasterConnectCom />}
          />
          <Route
          ...
          <Route path="/" element={<Layout />}>
            ...
            <Route path={"/section-blog"} element={<SectionBlog />} />
            <Route path={"/section-article"} element={<SectionArticle />} />
            ...
            <Route path="/design14" element={<Product />} />
            ...
            <Route path="/MyAccount" element={<LayoutSecure />}>
              ...
              <Route
                path="/MyAccount/successExtra"
                element={<SuccessExtra />}
              />
