...
const ThemeExampleSlideIn = () => {
  ...
  const designLinks = [
    ...
    { id: 6, name: "Wedding", link: "/design6", summary: "A wedding design", icon: <CameraIcon sx={{mr:1,color:"red"}} />, pic: `${staticImage}/design7.png`, display: "none" },
    { id: 7, name: "success", link: "/design8", summary: "Success, motivation page", icon: <FavoriteIcon  sx={{mr:1,color:"red"}}/>, pic: `${staticImage}/design8.png`, display: "none" },
    { id: 8, name: "Realtor", link: "/design9", summary: "realtor Specialist page", icon: <FavoriteIcon  sx={{mr:1,color:"red"}}/>, pic: `${staticImage}/design9.png`, display: "none" },
