        ...
        >
            <Container maxWidth="sm">
                <Grid container spacing={{ sx: 0, sm: 1 }} sx={{ margin: "auto", color: "white", position: "relative" }}>
                    ...
                    {credited &&
                        <Typography className={styles.credit} component="h1" variant="h6"
                            sx={{ fontSize: { xs: "160%", sm: "160%", md: "160%" } }}
                        >
                            <Stack direction="row" spacing={1} sx={{justifyContent:"center"}}>
                                <span>You have a credit of
                                ${credited.subTotal}.<sup>00</sup>
                                </span>
                                <small>monthly:${credited.subTotalMonthly}<sup>00</sup></small>
                            </Stack>
                        </Typography>
                    }
                </Grid>
