...
import { Box,Container,Stack,Grid,Typography, Checkbox, Paper } from '@mui/material';
...
const UserOrderList = () => {
    ...
    const {usersService,usersProduct,userPostService,userExtraService,jobsService,jobsPostService,jobsExtraService}=useContext(TokenAccessContext)
    ...
    },[setTaskProduct,setTaskService,setTaskPostService,setTaskExtraService,user_id]);
  ...
  return (
    ...
    >
        ...
        <Typography component="h1" variant="h3">Post Services(s)</Typography>
        <Grid container spacing={{xs:0,sm:1,md:2}} sx={{margin:"1rem auto"}}>
