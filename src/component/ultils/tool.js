...
const returnArr=[];
    const arr=[
        ...
        {id:5,name:"Maximize",size:{md:"950%",sm:"520%",xs:"400%"},top:{md:"30%",sm:"30%",xs:"36%"},left:{md:"46%",sm:"42%",xs:"17%"},color:"transparent",backgroundImage:"var(--background-image-1-turn)",rotate:"127deg"},
        {id:6,name:"Experience",size:{md:"750%",sm:"420%",xs:"355%"},top:{md:"20%",sm:"20%",xs:"32%"},left:{md:"65%",sm:"43%",xs:"1%"},color:"transparent",backgroundImage:"var(--background-1)",rotate:"270deg"},
        ...
        {id:9,name:"Developed",size:{md:"655%",sm:"380%",xs:"225%"},top:{md:"10%",sm:"17%",xs:"14%"},left:{md:"55%",sm:"52%",xs:"50%"},color:"blue",backgroundImage:null,rotate:"-45deg"},
        {id:10,name:"SEO",size:{md:"1055%",sm:"690%",xs:"425%"},top:{md:"40%",sm:"38%",xs:"41.5%"},left:{md:"75%",sm:"62%",xs:"57%"},color:"transparent",backgroundImage:"var(--background-hopefulHarvest)",rotate:"62deg"},
        ...
        {id:13,name:"Secure",size:{md:"1200%",sm:"620%",xs:"425%"},top:{md:"57%",sm:"55%",xs:"54%"},left:{md:"67%",sm:"48%",xs:"43%"},color:"transparent",backgroundImage:"var(--background-text-1)",rotate:"20deg"},
        {id:13,name:"Optimize",size:{md:"900%",sm:"480%",xs:"300%"},top:{md:"70%",sm:"70%",xs:"69%"},left:{md:"5%",sm:"2%",xs:"40%"},color:"blue",backgroundImage:null,rotate:"180deg"},
        ...
        {id:15,name:"Published",size:{md:"920%",sm:"545%",xs:"370%"},top:{md:"76%",sm:"72.5%",xs:"74%"},left:{md:"63%",sm:"40%",xs:"2%"},color:"transparent",backgroundImage:"var(--background-hopefulHarvest)",rotate:"-45deg"},
        ...
        {id:17,name:"Contracted",size:{md:"820%",sm:"415%",xs:"220%"},top:{md:"90%",sm:"99%",xs:"80%"},left:{md:"60%",sm:"20%",xs:"45%"},color:"yellow",backgroundImage:null,rotate:"-200deg"},
        ...
        {id:20,name:"Program",size:{md:"620%",sm:"385%",xs:"220%"},top:{md:"26%",sm:"88.5%",xs:"71%"},left:{md:"3%",sm:"56%",xs:"3%"},color:"transparent",backgroundImage:"var(--background-hopefulHarvest)",rotate:"290deg"},
