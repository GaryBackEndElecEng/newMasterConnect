...
const ParticularsPaidTotals = ({ invoicePaid, postInvoicePaid,extraInvoicePaid,largeFormat }) => {
    ...
    const getInvoice = invoicePaid.paid ? invoicePaid : false;
    const getPostInvoice = postInvoicePaid.paid ? postInvoicePaid : false;
    const activate = postInvoicePaid.paid ? true : false;
    const isExtraInvoice = extraInvoicePaid.paid ? 3 : 6;
