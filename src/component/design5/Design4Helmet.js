...
const Design4Helmet = ({keywords,summary,desc,image,OBJ,average,getPathLocation,pageRatings}) => {
...
const JSONProduct={
      ...
      "offers": {
        "@type": "Offer",
        "url":"https://www.master-connect.ca/design5",
        "priceCurrency": "CAD",
        "price": OBJ.monthly,
        "priceValidUntil": "N/A",
  ...
  return (
    <Helmet>
        ...
        <link rel="canonical" href={`${getPathLocation}/design5`} />
